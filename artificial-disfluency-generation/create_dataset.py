    ...
    if keep_fluent:
        ...
        if percentages_with_fluent is not None:
            ...
            if concat_files:
                ...
                final_df = pd.concat([final_df, fluent_set], ignore_index=True)
            ...
            if percentages_with_fluent[1] != 0:
                ...
                if concat_files:
                    ...
                    final_df = pd.concat([final_df, final_repeats], ignore_index=True)
            ...
            if percentages_with_fluent[2] != 0:
                ...
                if concat_files:
                    ...
                    final_df = pd.concat([final_df, restart_set], ignore_index=True)
            ...
            if percentages_with_fluent[3] != 0: # generating replacements
                ...
                if concat_files:
                    ...
                    final_df = pd.concat([final_df, final_replacements], ignore_index=True)
