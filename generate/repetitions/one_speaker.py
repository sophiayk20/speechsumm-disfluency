...
print(len(speaker_monologues.keys())) # this should be 1500!!! (length of test set)
...
def generate_repetition_one_speaker(instance_id, dialogue_dict, mode=Literal['ATAS', 'OTAS', 'ATOS', 'OTOS'], repetition_degree=2):
  ...
  BASE_FOLDER=f"/content/drive/MyDrive/ling384/repetitions/one_speaker"
